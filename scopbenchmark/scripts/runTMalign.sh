...
for i in  "${array[@]}"; do
	/home/stephkim/lib/TM-align/TMalign /storage/stephkim/prj-foldseek/organized_data/benchmark/data/scop-pdb/$id /storage/stephkim/prj-foldseek/organized_data/benchmark/data/scop-pdb/$i >> /storage/stephkim/prj-foldseek/organized_data/benchmark/results/tmalign/all-against-all/output/$id.out
done
