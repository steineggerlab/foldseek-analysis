...
if __name__ == '__main__':
    ...
    parser.add_argument('--hits', type=float, default=0.8, help='true positive threshold')
            ...
            if hit_counter > args.hits:
                ...
                for i,tuple in enumerate(aligned[0]):
                    if plddt_query[tuple[0]] >= 70:
                        test.append(plddt_query[tuple[0]])
                        query_lddt_info += f"{per_residue_lddt[0][i]:.3f},"
